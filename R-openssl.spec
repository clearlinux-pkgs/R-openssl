...
Version  : 1.4.5
Release  : 88
URL      : https://cran.r-project.org/src/contrib/openssl_1.4.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/openssl_1.4.5.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631213324
