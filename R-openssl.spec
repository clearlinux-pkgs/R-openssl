...
Version  : 2.3.3
Release  : 121
URL      : https://ftp.osuosl.org/pub/cran/src/contrib/openssl_2.3.3.tar.gz
Source0  : https://ftp.osuosl.org/pub/cran/src/contrib/openssl_2.3.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748355726
