...
Version  : 0.9.9
Release  : 38
URL      : https://cran.r-project.org/src/contrib/openssl_0.9.9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/openssl_0.9.9.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1510531136
