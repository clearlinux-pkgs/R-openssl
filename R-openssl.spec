...
Version  : 1.1
Release  : 55
URL      : https://cran.r-project.org/src/contrib/openssl_1.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/openssl_1.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1542430703
