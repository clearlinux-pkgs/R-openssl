...
Version  : 1.0.2
Release  : 52
URL      : https://cran.r-project.org/src/contrib/openssl_1.0.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/openssl_1.0.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1532974038
