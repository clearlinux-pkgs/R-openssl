...
Version  : 2.0.1
Release  : 96
URL      : https://cran.r-project.org/src/contrib/openssl_2.0.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/openssl_2.0.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1652683242
