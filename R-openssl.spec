...
Version  : 1.2.2
Release  : 60
URL      : https://cran.r-project.org/src/contrib/openssl_1.2.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/openssl_1.2.2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1551478039
...
/usr/lib64/R/library/openssl/mac-askpass
